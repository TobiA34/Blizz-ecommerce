 ...
 */
function shopper_shop_woocommerce_loop_columns() {
	return 4;
}
add_filter( 'loop_shop_columns', 'shopper_shop_woocommerce_loop_columns',999 );

if ( ! function_exists( 'shopper_shop_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
	 ...
	 * @return void
	 */
	function shopper_shop_woocommerce_wrapper_before() {
		/**
	  ...
	  if ( ! is_admin() && is_product() ) {
		 ...
		 do_action( 'shoper_container_wrap_start', esc_html( $layout ));
	}
}
add_action( 'woocommerce_before_main_content', 'shopper_shop_woocommerce_wrapper_before' );

if ( ! function_exists( 'shopper_shop_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
	 ...
	 * @return void
	 */
	function shopper_shop_woocommerce_wrapper_after() {
		/**
		...
		*/
		...
		do_action( 'shoper_container_wrap_end',esc_html( $layout ));
	}
}
add_action( 'woocommerce_after_main_content', 'shopper_shop_woocommerce_wrapper_after' );
