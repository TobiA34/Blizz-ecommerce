...
<article id="post-<?php the_ID(); ?>" <?php post_class( array('startup-shop-blogwrap') ); ?>>
    ...
    */
    ...
    <div class="post page-content">
        ...
        */
        do_action( 'startup_shop_site_content_type');
		wp_link_pages( array(
			'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'startup-shop' ),
			'after'  => '</div>',
		) );
        ?>
			...
			edit_post_link(
				sprintf(
					wp_kses(
						...
						__( 'Edit <span class="screen-reader-text">%s</span>', 'startup-shop' ),
						array(
							'span' => array(
								'class' => array(),
							),
